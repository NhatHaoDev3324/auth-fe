                ...
                <div className="flex flex-col md:flex-row gap-2">
                    <div className="grid">
                        ...
                        <Input
                            ...
                            className={`w-full focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none ${errors.firstName ? 'border-red-500 focus-visible:border-red-500' : 'focus-visible:border-input'}`}
                        />
                        <div className={"h-4"}>{errors.firstName && <small className="text-red-500">{errors.firstName}</small>}</div>
                    </div>

                    <div className="grid">
                        <Label htmlFor="lastName" className={"mb-2"}>Tên <span className="text-red-500">*</span></Label>
                        <Input
                            id="lastName"
                            type="text"
                            ...
                            className={`w-full focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:outline-none ${errors.lastName ? 'border-red-500 focus-visible:border-red-500' : 'focus-visible:border-input'}`}
                        />
                        <div className={"h-4"}>{errors.lastName && <small className="text-red-500">{errors.lastName}</small>}</div>
                    </div>
                </div>
